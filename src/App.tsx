        ...
        <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
              ...
              Fireflies.ai. Previously contributed to international astronomy software projects at Academia Sinica, 
              Taiwan's premier research institution, collaborating with US National Radio Astronomy Observatory 
              and global partners. Extensive experience in IoT and streaming technologies. Proven track record in 
